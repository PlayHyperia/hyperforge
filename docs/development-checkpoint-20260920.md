...
Current status: **localhost:3333 retains playable build109, .45 upper-normal grass shading and the v10 island; saved character/database and browser settings remain untouched.** Matched midday, low-sun, high-moon and low-moon views reproduce the user's sharp-grass complaint. Build110's shorter/greener recipe remains private; build111's .30 normal response is not a clear visual win and is not promoted. Thirty-two successful 2560×1440 stills establish these comparisons, not movement, sustained performance or AAA acceptance. Next: identify the blade-versus-ground lighting contributions before another material change; preserve the midday appearance. Authored-replacement and near-grass shadow adapters remain disabled.
...
Latest user art direction (2026-09-24): lush, fresh green like an upstate New York meadow, somewhat shorter than the current field, soft and flowing rather than yellow-olive, wiry or distracting. The improved playable shading is an intermediate checkpoint, not grass completion. Keep grass ahead of the audited water-composition task.

- [x] Compare one coordinated shorter/fresh-green field recipe against current build109 (CPU, isolated build110, native222/226 below). Horizontal reach, widths, seeded plants, flowers and population limits stay unchanged; analytic normals and swept grounding are recomputed. Accepted clump counts differ slightly, and visual fullness/nighttime cohesion remain unaccepted; the recipe is not promoted.
- [ ] Keep terrain and blade bases on the same CPU/GPU grass palette. Bring both toward a fresh temperate green and moderate broad dry-patch coloration; do not recolor only blades, bake illumination into albedo, raise exposure or remove real shadows. Inspect existing .45 normal response across direct sun, low sun, shade and nighttime before changing lighting again.
- [ ] Accept only after eye-level front/reverse and wider native 2× comparisons show a connected lush canopy without lime strips, a separate noisy ground layer, bald gaps or hidden flowers; then check continuous wind/walking/LOD transitions and cost. A photo is an art reference, not calibrated reflectance or a performance benchmark.

Visual reference inspected: [Spruceton Inn Catskills meadow](https://casey-scieszka-en2r.squarespace.com/) (mown-path meadow photograph: greener shaded lower canopy, warmer sunlit tips and irregular plant masses). No image asset or reference code was copied into the game.

Latest lighting priority: the user finds midday grass improved but nighttime/early-morning grass too sharp. Preserve the midday appearance while testing the complete lighting cycle; a color/height change alone is not an accepted solution.

- [x] Independently screen one private shorter/fresh-green recipe: field height factors `[.46,.72,.86]`, shared grade `[.68,1.24,1.5]`, softer dry tint `[1.12,1.08,1.15]`. Actual CPU/TSL arithmetic agrees; all three authored LODs retain exact XZ roots, widths, UVs and indices with recomputed analytic normals. Near template heights are .215–.603 m versus .243–.701 m. Summed top projection is unchanged, but side projection falls about 13.6%; fullness remains a visual gate.
- [x] Compile isolated build110 without changing production source or playable build109. All 1,102 raw inputs and 145 protected artifacts remain stable; the client, server framework and grounding worker receive the paired recipe. CPU receipt SHA `1b57c1f9766fa2fe85c0ab5b3017b8f1ceb8695e41b404f68749ed6cd4e4df77`; build110 report SHA `38b8237dcd2d1f78de261ec379499617fa980463a96765ed5c3f372b00a1919b`.
- [x] Capture fresh build109/native221 baseline: six standing-height front/reverse/wide views at actual 2560×1440, midday and 7.78° positive low sun, ordinary wind and no geometry/shadow adapters. Zero capture errors; actual all-LOD source buffers and .45 normal response verified. Main and independent visual review reproduce the user's low-sun complaint: bright strokes/dark gaps and stronger exposed-turf sparkle versus cohesive midday. This is not night, motion or performance acceptance.
- [x] Complete 24 native 2560×1440 views: build109/native221+225 and shorter/greener build110/native222+226, each front/reverse/wide at midday, 7.78° low sun, 67.25° high moon and 17.61° low moon. Each successful run has zero capture errors, owned browser closed and camera/clock restored. Failed native223 is retained: its test incorrectly required decorative moon/sun meshes intentionally omitted by the stream viewport; corrected225/226 verifies the actual retained sky dome and directional moonlight instead. No night geometry or lighting was fabricated.
- [x] Reject blanket SSS reduction as the general nighttime remedy. Independent review confirms both bright blade strokes and dark blade silhouettes against turf; high-moon sharpness remains despite near-overhead light. The incidence-gated floor hypothesis cannot improve that high-moon case and could worsen the dark silhouettes. Preserve genuine leaf transmission, ordinary lighting, PMREM, AO and shadows; do not hide the issue with exposure, blur or lower density.
- [x] Screen build111/native227: only field upper-normal weight .45→.30, root .2 unchanged. Eight front/reverse standing views at all four lighting phases completed without capture errors. Actual all-LOD source buffers match build109, and the submitted 40,962-byte grass fragment shader becomes byte-identical to the baseline after reversing that single coefficient. Seven other bundles, including the grounding worker, are byte-identical. This does not establish sustained frame time.
- [x] Decline .30 promotion after root and independent visual review: modest low-sun softening comes with paler/flatter midday ribbons; high/low-moon silhouettes and granular ground gaps remain. Stop this constant-weight sweep rather than treating a successful capture as artistic acceptance. One high-moon front view has three fewer clumps than its separately started baseline, within independently observed front-placement history; record it, do not force populations or claim pixel-identical wind/placements.
- [ ] Identify direct diffuse, indirect environment light, leaf scattering and substrate-detail contributions at the same day/night cameras before selecting another material intervention. Keep any diagnostic materials private; preserve the accepted midday look, native resolution, density, genuine shadows and performance limits.
- [ ] Hold build110 from playable promotion: its shorter, cooler-green presentation is promising, but low-sun/night separation persists and shorter silhouettes expose more grainy substrate in some views. It is not a nighttime lighting fix or a performance approval.
- [ ] Require preserved midday appearance, improved dawn/night cohesion, continuous wind/camera/day-cycle review and measured frame cost before declaring the meadow resolved.

Latest isolation evidence: `isolated-build111-report.json` SHA `a50f122d3455eb665c406abf72780d5fd778d9704f79dcb21293556d1f0765f1`; `native227/process.json` SHA `4e2463ba3871389439c09dc9d1b36cf68be655d44f68e5d600f3910ba2c10bfd`. All successful captures closed their owned browsers and restored camera/clock. Private runtimes173/174/175 stopped cleanly, removed only their disposable test databases, and verified protected playable/rollback artifacts unchanged.

Research: [Three MeshSSS material](https://threejs.org/docs/pages/MeshSSSNodeMaterial.html) and [Filament's approximate subsurface lighting](https://raw.githubusercontent.com/google/filament/main/shaders/src/surface_shading_model_subsurface.fs) inform the separation of broad scattering from genuine view-dependent transmission. No external shader source was copied. Local evidence: `meadow-shorter-lush-green-cpu01.json`, `isolated-build110-report.json`, `native221/process.json` (SHA `9aa43e48e831fd6ab992aa8734f5ec746ef907b8d4c33534f0653462124f2501`).
...
#### Near-shadow comparison and requested playable refresh — 2026-09-24

- [x] Inspect the actual grass material/shader and reference implementations. Native219 exposed a diagnostic WGSL/runtime binding-name mismatch; retain that failed run, fix the typed group/binding observer, then complete native220 with eight 2560×1440 images across four standing views. Existing selected clumps (156/154/156/154) cast real shadow draws without reseeding or changing original population/bytes.
- [x] Root and independent review inspect all eight images: only modest root/contact improvement, with broad crossing ribbons and competing grainy turf still visible. A 4096px shadow map spans 400m (about 9.8cm per texel); this experiment is not justification for a larger atlas or world-wide grass shadows. Actual draw submission is not GPU timing or motion/performance acceptance.
- [x] Restore all owned hooks/cast flags, zero private ledgers, close the owned browser and stop runtime172/remove only its private database. Postflight verifies protected artifacts, source/bundle pins, thirteen unrelated changes and closed private ports before the subsequent user-requested playable switch.
- [x] At the user's explicit request, safely refresh ordinary localhost:3333 from build104 to paired build109 client/server with a new Vite cache and v10-first asset overlay. Preview05 helper tests pass 28/28; four helper syntax checks and exact source/build/manifest admission pass. Two PostgreSQL custom archives are catalog-validated before/after quiescence, but not restore-tested. Preserve the same database/container/volume and character `sXQtmMRIIT`; do not reset graphics settings.
- [x] Verify server/database health and visually enter the normal playable world with avatar, inventory and HUD at its natural nighttime clock. Close only the owned verification tab. New ordinary services: server63609 on5555/5556, launcher63612/client63613 on3333. The public preview endpoint identifies build109 and upper-normal weight .45. Private authored replacement and near-shadow adapters are disabled; repository default remains1. This is a user-requested shading preview, not a production-default promotion.
- [ ] Continue coherent blade/ground material and turf-frequency work, then motion/traversal and sustained performance checks under suitable host conditions. Do not conflate source regression results or successful world entry with complete meadow art acceptance.

Evidence: service-layout `meadow-near-shadow-native219-01` (fixture failure), `meadow-near-shadow-native220-01`, `meadow-near-shadow-native220-postflight02` and `playable-meadow-preview05-execute01`; inland-pond `native220/process.json` SHA256 `b52a4f12f3f9d66ffe63d94018084c62918adb80e35f3c89c96be74ea4034937`, stopped runtime172 `454703aa894e474c8178e274e69930cd1a906f71a136aeca8d46f51f0331bd23`; playable `recovery05.json`, `preview05-public.json`, `preview05/saved-player-before-refresh.dump` and `preview05/saved-player-quiescent.dump`. Historical receipts remain unchanged; recovery05's initial visual-verification flag predates the subsequent successful live UI check.
