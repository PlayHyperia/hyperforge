...
Current status: **the unrecorded 2× run remains below the cadence target, and removing turf color detail does not resolve noisy grass blades.** Native201 preserves full population and records the short timing shortfall without video; native202 isolates the ground contribution. Both art reviews reject flat-albedo turf, and the original material is restored. Next separate blade lighting from albedo/geometry; do not continue blind substrate coefficient changes. Sustained performance, complete motion/reverse/low-sun review, normal gameplay effects and intermittent loading reliability remain open. The saved regular localhost game is unchanged. Earlier 28-instance planting comparisons still do not qualify the later 34-instance recipe; historical outcomes remain recorded below.
