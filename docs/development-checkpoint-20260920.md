...
Current status: **localhost:3333 serves retained-world build104 and the v10 island assets as an ordinary playable preview.** The saved character/database and editable 2× resolution/High shadow settings remain intact. This fixes stale preview delivery, not AAA/performance acceptance. Native208's canopy-shading experiment remains rejected and its original source restored. The private soft-meadow normal-response candidate has matched 2× still evidence (native209/210) and a completed bounded yaw/LOD motion route (native211), with density and geometry unchanged. Sampled motion views retain less scratchy contrast, but angular blades and grainy turf remain. Full reverse/low-sun, fine shimmer, normal-game effects and sustained performance remain open; no candidate promotion. Historical outcomes remain recorded below.
