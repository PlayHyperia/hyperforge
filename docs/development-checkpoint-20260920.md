...
Current status: **native208 completes the matched 2× canopy-shading trial but does not demonstrate a worthwhile visual improvement.** Both reviews still find shallow, uniform grass and flat angular blades. Preserve the experiment as evidence, not a selected default; the original source is restored with 133/133 appearance tests passing. Next target close blade silhouette and clump volume. The unrecorded 2× cadence shortfall, sustained performance, motion/reverse/low-sun review, normal gameplay effects and loading reliability remain open. The saved regular localhost game is unchanged. Historical outcomes remain recorded below; no diagnostic is promoted as an AAA/default pass.
