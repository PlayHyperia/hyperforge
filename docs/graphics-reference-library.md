...
Current status: **source/build checks and matched bank-detail captures pass; composition remains below the target and this stays opt-in/unqualified.** The grass-loading failure below is not fixed by this art change.
