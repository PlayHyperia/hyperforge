...
## 2026-09-23 — Dense fine-ribbon candidate source-verified; native art review next
...
- [ ] Next: isolated build83/runtime125/native168, matched to167/166 poses, verifying actual uploaded geometry, all-tier ribbon normal shaders, fresh population/clearance, unchanged flowers and terrain. Review fullness, leaf fineness, basal silhouette, angular bend, wind shimmer and LOD changes in real WebGPU images/motion. Native167 remains the last visually reviewed version and is still coarse/papery close-up. **Do not promote the new candidate or call it AAA before native review.**

Research basis: independent blade/density/detail controls in [Grassworks](https://grassworks.techredux.co/docs/grass/blade) and [GPUOpen curved grass rendering](https://gpuopen.com/learn/mesh_shaders/mesh_shaders-procedural_grass_rendering/). Principles are adapted to the existing WebGPU implementation; no external code copied or DirectX mesh-shader support implied. Evidence: service-layout `meadow-field-regression01`, `-grounding01`, `-bank01/02/03`, `-types01`, `-lint01`; inland-pond `meadow-field-source-review01.json`, SHA256 `a7c309cd5343a1650de8c91b398ccdf842a1447f553341cd422783c62e11c640`. Native rendering and visual acceptance are pending.
