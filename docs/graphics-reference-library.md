...
Current status: **localhost:3333 still serves retained-world build104 and the v10 island assets as an ordinary playable preview.** The saved character/database and editable 2× resolution/High shadows remain intact. The bounded refinement prototype now has actual-material/native 2× endpoint evidence and vertex-only storage containment, with unchanged coarse rendering. Its curve improvement is modest; soft-meadow cohesion, grain, shimmer and long-shadow coverage remain open. It is not integrated into live worker/grounding/ownership or performance-qualified. Next art work isolates turf normal detail before more refinement integration. No candidate promotion or AAA acceptance.
...
- [ ] Return the next art comparison to meadow/ground cohesion: isolate grass-substrate normal relief at fixed albedo, roughness/AO, blade population, sunlight and 2× resolution. Proposed private107/169/215 must use build106/native214 effective baselines, virtually restoring the two changed geometry-owner inputs so refinement cannot contaminate that comparison. Zero normal strength would be a diagnostic, not approval to ship flat ground. Do not spend further runtime integration effort assuming extra triangles solve the requested softness.
