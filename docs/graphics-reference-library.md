...
Current status: **localhost:3333 now serves retained-world build109 with the newer .45 upper-normal grass shading and v10 island assets, at the user's request.** The saved character/database and browser graphics settings are preserved. Ordinary world entry, avatar and HUD were visually checked at the natural nighttime clock; this is not movement, sustained performance or AAA acceptance. The authored-geometry replacement and near-grass shadow experiments remain disabled in this playable preview. Native220's eight frozen-camera images show only a modest contact-shadow improvement; next is coherent blade-to-ground material/turf balance, not more density or a larger shadow atlas.
