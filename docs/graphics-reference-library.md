...
Current status: **build99's opt-in low-leaf candidate now has native199 1× and native200 genuine 2× world/motion evidence.** Equal-display-size review finds cleaner sampling at 2× with unchanged grass placement/population, but angular/thin-line material noise remains. Recorded 2× cadence is lower and uneven; unrecorded profiling is next, not a performance pass. Complete perceptual motion, reverse/low-sun, sustained performance, normal gameplay effects and intermittent grass-loading reliability remain open. The saved regular localhost game is unchanged. Earlier 28-instance planting comparisons still do not qualify the later 34-instance recipe. Historical entries retain their original outcomes; the latest result is recorded in “Genuine 2× meadow comparison.”
