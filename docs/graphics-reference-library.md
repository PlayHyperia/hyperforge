...
Current status: **field-lighting isolation substantially reduces dark grass scratches, but unlit grass fails shadow coherence and is not selected.** Native203 preserves exact geometry/population and isolates the existing albedo from lighting; both art reviews still see angular ribbons. The original source is restored with 133/133 appearance tests passing. Next test coherent fully lit meadow shading while retaining real shadows, rather than more ground-albedo or diffuse-wrap sweeps. The earlier unrecorded 2× cadence shortfall, sustained performance, motion/reverse/low-sun review, normal gameplay effects and loading reliability remain open. The saved regular localhost game is unchanged. Historical outcomes remain recorded below; older sparse-meadow normal choices do not qualify the current denser field.
