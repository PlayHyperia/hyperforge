...
Current status: **localhost:3333 serves retained-world build104 and the v10 island assets as an ordinary playable preview.** The saved character/database and editable 2× resolution/High shadow settings remain intact. The private soft-meadow normal-response candidate has matched still and bounded-motion evidence, but close blades remain angular/flat and turf grain still competes. The local sunlight-ray correction now also has six actual 2× WebGPU day/low-sun views in build106/native214, with unchanged grass geometry/population and correct sky/light direction. This is not a meadow-softness fix; relocated long shadows, lighting transitions, fine shimmer, normal-game effects and sustained performance remain open. A bounded near-camera blade-refinement prototype is planned, not accepted. No candidate promotion or AAA acceptance. Historical outcomes remain recorded below.
