...
Current status: **native204's coherent lit normal endpoint reduces scratch-like grass contrast while retaining real tree/pavilion shadows.** Both art reviews support the direction but find the pure terrain-normal treatment too uniform, with flat angular blades still unresolved. The diagnostic is preserved and original source restored with 133/133 appearance tests passing. Next build one bounded canopy-scale shading treatment and compare under explicitly matched lighting. The unrecorded 2× cadence shortfall, sustained performance, motion/reverse/low-sun review, normal gameplay effects and loading reliability remain open. The saved regular localhost game is unchanged. Historical outcomes remain recorded below; no diagnostic is promoted as an AAA/default pass.
