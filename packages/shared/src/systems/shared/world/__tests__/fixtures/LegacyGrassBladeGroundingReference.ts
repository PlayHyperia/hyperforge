/** Frozen pre-review52-optimization exhaustive grounding oracle, captured
 * 2026-09-19. Numerical core, validation and generic triangle traversal are
 * preserved; only the unused continuation wrapper is omitted and imports are
 * relocated. Never used by production. Independent per-clump results are a
 * mathematical reference, NOT proof that a full installation meets its caps.
 * Keep this algorithm frozen when optimizing the production implementation. */
