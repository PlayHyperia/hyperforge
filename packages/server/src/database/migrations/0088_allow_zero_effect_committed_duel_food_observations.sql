-- A food item can commit custody while applying zero health when a concurrent
-- terminal/full-health transition wins the character lock. Preserve that exact
-- public fact instead of dropping the action or falsely reporting a rejection.
